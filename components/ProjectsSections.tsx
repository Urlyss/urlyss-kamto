...
const ProjectsSections = async ({ id }: { id: string }) => {
  ...
  return (
    <SectionWrapper id={`${id}`} className="flex flex-col justify-start bg-background text-foreground !px-0 gap-20">
      <div className="max-w-xl flex flex-col gap-4 lg:px-20 px-4">
        ...
        <h2 className="lg:text-2xl font-semibold">
          {`Swipe or drag below to see a selection of projects I've worked
          on.`}
        </h2>
      </div>
